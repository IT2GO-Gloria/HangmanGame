...
/* TO CHANGE IMAGE WITH EACH LETTER GUESS
  do {
    img id="hangman-img" src="strike-0.png"
  }while hangman-lives == 6;

  do {
    img id="hangman-img" src="strike-1.png"
  }while hangman-lives == 5;

  do {
    img id="hangman-img" src="strike-2.png"
  }while hangman-lives == 4;

  do {
    img id="hangman-img" src="strike-3.png"
  }while hangman-lives == 3;

  do {
    img id="hangman-img" src="strike-4.png"
  }while hangman-lives == 2;

  do {
    img id="hangman-img" src="strike-5.png"
  }while hangman-lives == 1;

  do {
    img id="hangman-img" src="strike-6.png"
